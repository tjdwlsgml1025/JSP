 ...
 */
@WebServlet("/home") //(1)첫번째 = 경로 지정
public class Home extends HttpServlet { //상속받음=doGet,doPost오버라이딩 하기 위해
    ...
    //(2)두번째 - get방식호출 =tomcat이 알아서 > 서버에 있는 모든 정보를 자바에서 사용하기 쉽도록 request객체로 바꿔줌 >받은 정보들을 response객체로 해서String형태로제출해줌
